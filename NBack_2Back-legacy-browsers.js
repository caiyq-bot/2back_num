...
async function experimentInit() {
  ...
  instr_sound.isPlaying = false;
  instr_sound.isFinished = false;
  ...
  welpage_2 = new visual.TextStim({
    ...
    font: 'Heiti SC',
    units: undefined, 
    pos: [0, 0.35], draggable: false, height: 0.035,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('white'),  opacity: undefined,
    depth: 0.0 
  });
  ...
  instr_2_sound.isPlaying = false;
  instr_2_sound.isFinished = false;
  ...
  instr_3_sound.isPlaying = false;
  instr_3_sound.isFinished = false;
  ...
  instr_3_1_sound.isPlaying = false;
  instr_3_1_sound.isFinished = false;
  ...
  instr_3_2_sound.isPlaying = false;
  instr_3_2_sound.isFinished = false;
  ...
  instr_3_3_sound.isPlaying = false;
  instr_3_3_sound.isFinished = false;
  ...
  instr_3_4_sound.isPlaying = false;
  instr_3_4_sound.isFinished = false;
  ...
  instr_3_5_sound.isPlaying = false;
  instr_3_5_sound.isFinished = false;
  ...
  instr_3_6_sound.isPlaying = false;
  instr_3_6_sound.isFinished = false;
  ...
  text_13 = new visual.TextStim({
    ...
    font: 'Open Sans',
    units: undefined, 
    pos: [(- 0.1), 0.03], draggable: false, height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color([1.0, 1.0, 1.0]),  opacity: undefined,
    depth: -2.0 
  });
  ...
  text_8 = new visual.TextStim({
    ...
    font: 'Open Sans',
    units: undefined, 
    pos: [(- 0.2), 0.03], draggable: false, height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color([1.0, 1.0, 1.0]),  opacity: undefined,
    depth: -3.0 
  });
  ...
  instr_3_7_sound.isPlaying = false;
  instr_3_7_sound.isFinished = false;
  ...
  instr_3_8_sound.isPlaying = false;
  instr_3_8_sound.isFinished = false;
  ...
  text_21 = new visual.TextStim({
    ...
    font: 'Open Sans',
    units: undefined, 
    pos: [(- 0.3), 0.03], draggable: false, height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color([1.0, 1.0, 1.0]),  opacity: undefined,
    depth: -4.0 
  });
  ...
  instr_3_9_sound.isPlaying = false;
  instr_3_9_sound.isFinished = false;
  ...
  instr_3_8_sound_2.isPlaying = false;
  instr_3_8_sound_2.isFinished = false;
  ...
  text_41 = new visual.TextStim({
    ...
    font: 'Open Sans',
    units: undefined, 
    pos: [(- 0.4), 0.03], draggable: false, height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('white'),  opacity: undefined,
    depth: -5.0 
  });
  ...
  instr_3_9_sound_2.isPlaying = false;
  instr_3_9_sound_2.isFinished = false;
  ...
  instr_3_6_sound_2.isPlaying = false;
  instr_3_6_sound_2.isFinished = false;
  ...
  text_43 = new visual.TextStim({
    ...
    font: 'Open Sans',
    units: undefined, 
    pos: [(- 0.5), 0.03], draggable: false, height: 0.03,  wrapWidth: undefined, ori: 0.0,
    languageStyle: 'LTR',
    color: new util.Color('white'),  opacity: undefined,
    depth: -6.0 
  });
  ...
  instr_3_9_sound_3.isPlaying = false;
  instr_3_9_sound_3.isFinished = false;
  ...
  instr_4_sound.isPlaying = false;
  instr_4_sound.isFinished = false;
  ...
  instr_4_sound_2.isPlaying = false;
  instr_4_sound_2.isFinished = false;
  ...
  instr_4_1_sound.isPlaying = false;
  instr_4_1_sound.isFinished = false;
  ...
  instr_4_2_sound.isPlaying = false;
  instr_4_2_sound.isFinished = false;
  ...
  prac_rest_sound.isPlaying = false;
  prac_rest_sound.isFinished = false;
  ...
  prac_feedb_sound.isPlaying = false;
  prac_feedb_sound.isFinished = false;
  ...
  instr_sound_5.isPlaying = false;
  instr_sound_5.isFinished = false;
...
function instrRoutineEachFrame() {
  return async function () {
    ...
    if (welpage.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (instr_sound.status === STARTED) {
        instr_sound.isPlaying = true;
        if (t >= (instr_sound.getDuration() + instr_sound.tStart)) {
            instr_sound.isFinished = true;
        }
    }
    ...
    if (instr_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_sound.isFinished) {
...
function instr_2RoutineEachFrame() {
  return async function () {
    ...
    if (welpage_2.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (welpage_2_2.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (same_e_g.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if instr_key_resp_2 is active this frame...
    if (instr_key_resp_2.status === PsychoJS.Status.STARTED) {
      let theseKeys = instr_key_resp_2.getKeys({
        keyList: typeof 'z' === 'string' ? ['z'] : 'z', 
        waitRelease: false
      });
    ...
    if (instr_2_sound.status === STARTED) {
        instr_2_sound.isPlaying = true;
        if (t >= (instr_2_sound.getDuration() + instr_2_sound.tStart)) {
            instr_2_sound.isFinished = true;
        }
    }
    ...
    if (instr_2_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_2_sound.isFinished) {
      // keep track of stop time/frame for later
...
function instr_3RoutineEachFrame() {
  return async function () {
    ...
    if (welpage_3.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (welpage_3_2.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (different_e_g.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if instr_key_resp_3 is active this frame...
    if (instr_key_resp_3.status === PsychoJS.Status.STARTED) {
      let theseKeys = instr_key_resp_3.getKeys({
    ...
    if (instr_3_sound.status === STARTED) {
        instr_3_sound.isPlaying = true;
        if (t >= (instr_3_sound.getDuration() + instr_3_sound.tStart)) {
            instr_3_sound.isFinished = true;
        }
    }
    ...
    if (instr_3_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_1MaxDurationReached;
var _instr_key_resp_3_1_allKeys;
var instr_3_1MaxDuration;
...
function instr_3_1RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_1Clock.reset();
    routineTimer.reset();
    instr_3_1MaxDurationReached = false;
    // update component parameters for each repeat
...
function instr_3_1RoutineEachFrame() {
  return async function () {
    ...
    if (welpage_3_1.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if instr_key_resp_3_1 is active this frame...
    if (instr_key_resp_3_1.status === PsychoJS.Status.STARTED) {
      let theseKeys = instr_key_resp_3_1.getKeys({
        keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
        waitRelease: false
      });
    ...
    if (instr_3_1_sound.status === STARTED) {
        instr_3_1_sound.isPlaying = true;
        if (t >= (instr_3_1_sound.getDuration() + instr_3_1_sound.tStart)) {
            instr_3_1_sound.isFinished = true;
        }
    }
    ...
    if (instr_3_1_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_1_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_2MaxDurationReached;
var instr_3_2MaxDuration;
...
function instr_3_2RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_2Clock.reset(routineTimer.getTime());
    routineTimer.add(6.000000);
    instr_3_2MaxDurationReached = false;
    // update component parameters for each repeat
    instr_3_2_sound.isFinished = false;
    instr_3_2_sound.secs=6;
    instr_3_2_sound.setVolume(1.0);
    psychoJS.experiment.addData('instr_3_2.started', globalClock.getTime());
    instr_3_2MaxDuration = null
    // keep track of which components have finished
    instr_3_2Components = [];
    ...
    instr_3_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_2RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_2_sound.status === STARTED) {
        instr_3_2_sound.isPlaying = true;
        if (t >= (instr_3_2_sound.getDuration() + instr_3_2_sound.tStart)) {
            instr_3_2_sound.isFinished = true;
        }
    }
    ...
    frameRemains = 0.0 + 6 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
    if (instr_3_2_sound.status === PsychoJS.Status.STARTED && t >= frameRemains || instr_3_2_sound.isFinished) {
      // keep track of stop time/frame for later
...
function instr_3_2RoutineEnd(snapshot) {
  return async function () {
    ...
    if (routineForceEnded) {
        routineTimer.reset();} else if (instr_3_2MaxDurationReached) {
        instr_3_2Clock.add(instr_3_2MaxDuration);
    } else {
        instr_3_2Clock.add(6.000000);
    }
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
...
var instr_3_3MaxDurationReached;
var _key_resp_2_allKeys;
var instr_3_3MaxDuration;
...
function instr_3_3RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_3Clock.reset();
    routineTimer.reset();
    instr_3_3MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_3RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_3_sound.status === STARTED) {
        instr_3_3_sound.isPlaying = true;
        if (t >= (instr_3_3_sound.getDuration() + instr_3_3_sound.tStart)) {
            instr_3_3_sound.isFinished = true;
        }
    }
    ...
    if (instr_3_3_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_3_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_4MaxDurationReached;
var instr_3_4MaxDuration;
...
function instr_3_4RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_4Clock.reset(routineTimer.getTime());
    routineTimer.add(6.000000);
    instr_3_4MaxDurationReached = false;
    // update component parameters for each repeat
    instr_3_4_sound.isFinished = false;
    instr_3_4_sound.secs=6;
    instr_3_4_sound.setVolume(1.0);
    psychoJS.experiment.addData('instr_3_4.started', globalClock.getTime());
    instr_3_4MaxDuration = null
    // keep track of which components have finished
    instr_3_4Components = [];
    ...
    instr_3_4Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_4RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_4_sound.status === STARTED) {
        instr_3_4_sound.isPlaying = true;
        if (t >= (instr_3_4_sound.getDuration() + instr_3_4_sound.tStart)) {
            instr_3_4_sound.isFinished = true;
        }
    }
    ...
    frameRemains = 0.0 + 6 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
    if (instr_3_4_sound.status === PsychoJS.Status.STARTED && t >= frameRemains || instr_3_4_sound.isFinished) {
      // keep track of stop time/frame for later
...
function instr_3_4RoutineEnd(snapshot) {
  return async function () {
    ...
    if (routineForceEnded) {
        routineTimer.reset();} else if (instr_3_4MaxDurationReached) {
        instr_3_4Clock.add(instr_3_4MaxDuration);
    } else {
        instr_3_4Clock.add(6.000000);
    }
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
...
var instr_3_5MaxDurationReached;
var _key_resp_3_allKeys;
var instr_3_5MaxDuration;
...
function instr_3_5RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_5Clock.reset();
    routineTimer.reset();
    instr_3_5MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_5Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_5RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_5_sound.status === STARTED) {
        instr_3_5_sound.isPlaying = true;
        if (t >= (instr_3_5_sound.getDuration() + instr_3_5_sound.tStart)) {
            instr_3_5_sound.isFinished = true;
        }
    }
    ...
    if (instr_3_5_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_5_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_6MaxDurationReached;
var _key_resp_4_allKeys;
var instr_3_6MaxDuration;
...
function instr_3_6RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_6Clock.reset();
    routineTimer.reset();
    instr_3_6MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_6Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
  ...
  return async function () {
    ...
    if (key_resp_4.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_resp_4.getKeys({
        keyList: typeof ['z','m'] === 'string' ? [['z','m']] : ['z','m'], 
        waitRelease: false
      });
    ...
    if (instr_3_6_sound.status === STARTED) {
        instr_3_6_sound.isPlaying = true;
        if (t >= (instr_3_6_sound.getDuration() + instr_3_6_sound.tStart)) {
            instr_3_6_sound.isFinished = true;
        }
    }
    ...
    if (instr_3_6_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_6_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_7MaxDurationReached;
var _key_resp_5_allKeys;
var instr_3_7MaxDuration;
...
function instr_3_7RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_7Clock.reset();
    routineTimer.reset();
    instr_3_7MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_7Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_7RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_7_sound.status === STARTED) {
        instr_3_7_sound.isPlaying = true;
        if (t >= (instr_3_7_sound.getDuration() + instr_3_7_sound.tStart)) {
            instr_3_7_sound.isFinished = true;
        }
    }
    ...
    if (instr_3_7_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_7_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_8MaxDurationReached;
var _key_resp_6_allKeys;
var instr_3_8MaxDuration;
...
function instr_3_8RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_8Clock.reset();
    routineTimer.reset();
    instr_3_8MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_8Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_8RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_8_sound.status === STARTED) {
        instr_3_8_sound.isPlaying = true;
        if (t >= (instr_3_8_sound.getDuration() + instr_3_8_sound.tStart)) {
            instr_3_8_sound.isFinished = true;
        }
    }
    ...
    if (instr_3_8_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_8_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_9MaxDurationReached;
var _key_resp_7_allKeys;
var instr_3_9MaxDuration;
...
function instr_3_9RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_9Clock.reset();
    routineTimer.reset();
    instr_3_9MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_9Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_9RoutineEachFrame() {
  return async function () {
    ...
    if (text_18.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (instr_3_9_sound.status === STARTED) {
        instr_3_9_sound.isPlaying = true;
        if (t >= (instr_3_9_sound.getDuration() + instr_3_9_sound.tStart)) {
            instr_3_9_sound.isFinished = true;
        }
    }
    ...
    if (instr_3_9_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_9_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_10MaxDurationReached;
var _key_resp_8_allKeys;
var instr_3_10MaxDuration;
...
function instr_3_10RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_10Clock.reset();
    routineTimer.reset();
    instr_3_10MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_10Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_10RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_8_sound_2.status === STARTED) {
        instr_3_8_sound_2.isPlaying = true;
        if (t >= (instr_3_8_sound_2.getDuration() + instr_3_8_sound_2.tStart)) {
            instr_3_8_sound_2.isFinished = true;
        }
    }
    ...
    if (instr_3_8_sound_2.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_8_sound_2.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_11MaxDurationReached;
var _key_resp_9_allKeys;
var instr_3_11MaxDuration;
...
function instr_3_11RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_11Clock.reset();
    routineTimer.reset();
    instr_3_11MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_11Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_11RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_9_sound_2.status === STARTED) {
        instr_3_9_sound_2.isPlaying = true;
        if (t >= (instr_3_9_sound_2.getDuration() + instr_3_9_sound_2.tStart)) {
            instr_3_9_sound_2.isFinished = true;
        }
    }
    ...
    if (instr_3_9_sound_2.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_9_sound_2.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_12MaxDurationReached;
var _key_resp_10_allKeys;
var instr_3_12MaxDuration;
...
function instr_3_12RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_12Clock.reset();
    routineTimer.reset();
    instr_3_12MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_12Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_12RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_6_sound_2.status === STARTED) {
        instr_3_6_sound_2.isPlaying = true;
        if (t >= (instr_3_6_sound_2.getDuration() + instr_3_6_sound_2.tStart)) {
            instr_3_6_sound_2.isFinished = true;
        }
    }
    ...
    if (instr_3_6_sound_2.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_6_sound_2.isFinished) {
      // keep track of stop time/frame for later
...
var instr_3_13MaxDurationReached;
var _key_resp_11_allKeys;
var instr_3_13MaxDuration;
...
function instr_3_13RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_3_13Clock.reset();
    routineTimer.reset();
    instr_3_13MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_3_13Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_3_13RoutineEachFrame() {
  return async function () {
    ...
    if (instr_3_9_sound_3.status === STARTED) {
        instr_3_9_sound_3.isPlaying = true;
        if (t >= (instr_3_9_sound_3.getDuration() + instr_3_9_sound_3.tStart)) {
            instr_3_9_sound_3.isFinished = true;
        }
    }
    ...
    if (instr_3_9_sound_3.status === PsychoJS.Status.STARTED && Boolean(false) || instr_3_9_sound_3.isFinished) {
      // keep track of stop time/frame for later
...
var end_prac_judgeMaxDurationReached;
var _key_into_prac_allKeys;
var end_prac_judgeMaxDuration;
...
function end_prac_judgeRoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    end_prac_judgeClock.reset();
    routineTimer.reset();
    end_prac_judgeMaxDurationReached = false;
    // update component parameters for each repeat
...
function end_prac_judgeRoutineEachFrame() {
  return async function () {
    ...
    if (into_prac.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if key_into_prac is active this frame...
    if (key_into_prac.status === PsychoJS.Status.STARTED) {
      let theseKeys = key_into_prac.getKeys({
        keyList: typeof ['1','4'] === 'string' ? [['1','4']] : ['1','4'], 
        waitRelease: false
      });
...
function instr_4RoutineEachFrame() {
  return async function () {
    ...
    if (welpage_4.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if instr_key_resp_4 is active this frame...
    if (instr_key_resp_4.status === PsychoJS.Status.STARTED) {
      let theseKeys = instr_key_resp_4.getKeys({
        keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
        waitRelease: false
      });
    ...
    if (instr_4_sound.status === STARTED) {
        instr_4_sound.isPlaying = true;
        if (t >= (instr_4_sound.getDuration() + instr_4_sound.tStart)) {
            instr_4_sound.isFinished = true;
        }
    }
    ...
    if (instr_4_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_4_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_4_3MaxDurationReached;
var _instr_key_resp_8_allKeys;
var instr_4_3MaxDuration;
...
function instr_4_3RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_4_3Clock.reset();
    routineTimer.reset();
    instr_4_3MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_4_3Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_4_3RoutineEachFrame() {
  return async function () {
    ...
    if (welpage_7.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if instr_key_resp_8 is active this frame...
    if (instr_key_resp_8.status === PsychoJS.Status.STARTED) {
      let theseKeys = instr_key_resp_8.getKeys({
        keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
        waitRelease: false
      });
    ...
    if (instr_4_sound_2.status === STARTED) {
        instr_4_sound_2.isPlaying = true;
        if (t >= (instr_4_sound_2.getDuration() + instr_4_sound_2.tStart)) {
            instr_4_sound_2.isFinished = true;
        }
    }
    ...
    if (instr_4_sound_2.status === PsychoJS.Status.STARTED && Boolean(false) || instr_4_sound_2.isFinished) {
      // keep track of stop time/frame for later
...
var instr_4_1MaxDurationReached;
var _instr_key_resp_6_allKeys;
var instr_4_1MaxDuration;
...
function instr_4_1RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_4_1Clock.reset();
    routineTimer.reset();
    instr_4_1MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_4_1Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_4_1RoutineEachFrame() {
  return async function () {
    ...
    if (welpage_5.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if instr_key_resp_6 is active this frame...
    if (instr_key_resp_6.status === PsychoJS.Status.STARTED) {
      let theseKeys = instr_key_resp_6.getKeys({
        keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
        waitRelease: false
      });
    ...
    if (instr_4_1_sound.status === STARTED) {
        instr_4_1_sound.isPlaying = true;
        if (t >= (instr_4_1_sound.getDuration() + instr_4_1_sound.tStart)) {
            instr_4_1_sound.isFinished = true;
        }
    }
    ...
    if (instr_4_1_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_4_1_sound.isFinished) {
      // keep track of stop time/frame for later
...
var instr_4_2MaxDurationReached;
var _instr_key_resp_7_allKeys;
var instr_4_2MaxDuration;
...
function instr_4_2RoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    instr_4_2Clock.reset();
    routineTimer.reset();
    instr_4_2MaxDurationReached = false;
    // update component parameters for each repeat
    ...
    instr_4_2Components.forEach( function(thisComponent) {
      if ('status' in thisComponent)
        thisComponent.status = PsychoJS.Status.NOT_STARTED;
       });
    return Scheduler.Event.NEXT;
...
function instr_4_2RoutineEachFrame() {
  return async function () {
    ...
    if (welpage_6.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if instr_key_resp_7 is active this frame...
    if (instr_key_resp_7.status === PsychoJS.Status.STARTED) {
      let theseKeys = instr_key_resp_7.getKeys({
        keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
        waitRelease: false
      });
    ...
    if (instr_4_2_sound.status === STARTED) {
        instr_4_2_sound.isPlaying = true;
        if (t >= (instr_4_2_sound.getDuration() + instr_4_2_sound.tStart)) {
            instr_4_2_sound.isFinished = true;
        }
    }
    ...
    if (instr_4_2_sound.status === PsychoJS.Status.STARTED && Boolean(false) || instr_4_2_sound.isFinished) {
      // keep track of stop time/frame for later
...
var prac_restMaxDurationReached;
var prac_rest_audio;
var _prac_rest_key_resp_allKeys;
var prac_restMaxDuration;
...
function prac_restRoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    prac_restClock.reset();
    routineTimer.reset();
    prac_restMaxDurationReached = false;
    // update component parameters for each repeat
...
function prac_restRoutineEachFrame() {
  return async function () {
    ...
    if (prac_rest_instr.status === PsychoJS.Status.STARTED) {
    }
    ...
    // if prac_rest_key_resp is active this frame...
    if (prac_rest_key_resp.status === PsychoJS.Status.STARTED) {
      let theseKeys = prac_rest_key_resp.getKeys({
        keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
        waitRelease: false
      });
    ...
    if (prac_rest_sound.status === STARTED) {
        prac_rest_sound.isPlaying = true;
        if (t >= (prac_rest_sound.getDuration() + prac_rest_sound.tStart)) {
            prac_rest_sound.isFinished = true;
        }
    }
    ...
    if (prac_rest_sound.status === PsychoJS.Status.STARTED && Boolean(false) || prac_rest_sound.isFinished) {
      // keep track of stop time/frame for later
...
var prac_fixationMaxDurationReached;
var prac_fixationMaxDuration;
...
function prac_fixationRoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    prac_fixationClock.reset(routineTimer.getTime());
    routineTimer.add(0.500000);
    prac_fixationMaxDurationReached = false;
    // update component parameters for each repeat
    psychoJS.experiment.addData('prac_fixation.started', globalClock.getTime());
    prac_fixationMaxDuration = null
    // keep track of which components have finished
...
function prac_fixationRoutineEachFrame() {
  return async function () {
    ...
    if (prac_fix.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (prac_fix.status === PsychoJS.Status.STARTED && t >= frameRemains) {
      ...
      // update status
      prac_fix.status = PsychoJS.Status.FINISHED;
...
function prac_fixationRoutineEnd(snapshot) {
  return async function () {
    ...
    if (routineForceEnded) {
        routineTimer.reset();} else if (prac_fixationMaxDurationReached) {
        prac_fixationClock.add(prac_fixationMaxDuration);
    } else {
        prac_fixationClock.add(0.500000);
    }
    // Routines running outside a loop should always advance the datafile row
    if (currentLoop === psychoJS.experiment) {
      psychoJS.experiment.nextEntry(snapshot);
...
var prac_expMaxDurationReached;
var numlist;
var _prac_key_resp_allKeys;
var prac_expMaxDuration;
...
function prac_expRoutineBegin(snapshot) {
  return async function () {
    ...
    // keep track of whether this Routine was forcibly ended
    routineForceEnded = false;
    prac_expClock.reset(routineTimer.getTime());
    routineTimer.add(2.260000);
    prac_expMaxDurationReached = false;
    // update component parameters for each repeat
...
function prac_expRoutineEachFrame() {
  return async function () {
    ...
    if (prac_stimu.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (prac_stimu.status === PsychoJS.Status.STARTED && t >= frameRemains) {
      ...
      // update status
      prac_stimu.status = PsychoJS.Status.FINISHED;
    ...
    if (prac_blank.status === PsychoJS.Status.STARTED) {
    }
    ...
    if (prac_blank.status === PsychoJS.Status.STARTED && t >= frameRemains) {
      ...
      // update status
      prac_blank.status = PsychoJS.Status.FINISHED;
    ...
    if (prac_key_resp.status === PsychoJS.Status.STARTED && t >= frameRemains) {
      ...
      // if prac_key_resp is active this frame...
      if (prac_key_resp.status === PsychoJS.Status.STARTED) {
        let theseKeys = prac_key_resp.getKeys({
          keyList: typeof ['z','m'] === 'string' ? [['z','m']] : ['z','m'], 
          waitRelease: false
        });
...
function prac_expRoutineEnd(snapshot) {
    return async function () {
      ...
      prac_key_resp.stop();
      if (routineForceEnded) {
          routineTimer.reset();} else if (prac_expMaxDurationReached) {
          prac_expClock.add(prac_expMaxDuration);
      } else {
          prac_expClock.add(2.260000);
      }
      // Routines running outside a loop should always advance the datafile row
      if (currentLoop === psychoJS.experiment) {
        psychoJS.experiment.nextEntry(snapshot);
...
var prac_trial_fbMaxDurationReached;
var prac_trial_fbMaxDuration;
...
function prac_trial_fbRoutineBegin(snapshot) {
    return async function () {
      ...
      // keep track of whether this Routine was forcibly ended
      routineForceEnded = false;
      prac_trial_fbClock.reset(routineTimer.getTime());
      routineTimer.add(0.650000);
      prac_trial_fbMaxDurationReached = false;
      // update component parameters for each repeat
...
function prac_trial_fbRoutineEachFrame() {
    return async function () {
      ...
      if (prac_feedb_text.status === PsychoJS.Status.STARTED) {
      }
      ...
      if (prac_feedb_text.status === PsychoJS.Status.STARTED && t >= frameRemains) {
        ...
        // update status
        prac_feedb_text.status = PsychoJS.Status.FINISHED;
        prac_feedb_text.setAutoDraw(false);
      }
      
      if (prac_feedb_sound.status === STARTED) {
          prac_feedb_sound.isPlaying = true;
          if (t >= (prac_feedb_sound.getDuration() + prac_feedb_sound.tStart)) {
              prac_feedb_sound.isFinished = true;
          }
      }
      ...
      frameRemains = 0.0 + 0.65 - psychoJS.window.monitorFramePeriod * 0.75;// most of one frame period left
      if (prac_feedb_sound.status === PsychoJS.Status.STARTED && t >= frameRemains || prac_feedb_sound.isFinished) {
        // keep track of stop time/frame for later
...
function prac_trial_fbRoutineEnd(snapshot) {
    return async function () {
      ...
      if (routineForceEnded) {
          routineTimer.reset();} else if (prac_trial_fbMaxDurationReached) {
          prac_trial_fbClock.add(prac_trial_fbMaxDuration);
      } else {
          prac_trial_fbClock.add(0.650000);
      }
      // Routines running outside a loop should always advance the datafile row
      if (currentLoop === psychoJS.experiment) {
        psychoJS.experiment.nextEntry(snapshot);
...
var prac_block_fbMaxDurationReached;
var _prac_block_fb_key_resp_allKeys;
var prac_block_fbMaxDuration;
...
function prac_block_fbRoutineBegin(snapshot) {
    return async function () {
      ...
      // keep track of whether this Routine was forcibly ended
      routineForceEnded = false;
      prac_block_fbClock.reset();
      routineTimer.reset();
      prac_block_fbMaxDurationReached = false;
      // update component parameters for each repeat
...
function prac_block_fbRoutineEachFrame() {
    return async function () {
      ...
      if (prac_block_feedb_text.status === PsychoJS.Status.STARTED) {
      }
      ...
      // if prac_block_fb_key_resp is active this frame...
      if (prac_block_fb_key_resp.status === PsychoJS.Status.STARTED) {
        let theseKeys = prac_block_fb_key_resp.getKeys({
          keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
          waitRelease: false
        });
...
var instr_5MaxDurationReached;
var _instr_key_resp_5_allKeys;
var instr_5MaxDuration;
...
function instr_5RoutineBegin(snapshot) {
    return async function () {
      ...
      instr_5Clock.reset();
      routineTimer.reset();
      instr_5MaxDurationReached = false;
      // update component parameters for each repeat
...
function instr_5RoutineEachFrame() {
    return async function () {
      ...
      if (welpage_exp.status === PsychoJS.Status.STARTED) {
      }
      ...
      // if instr_key_resp_5 is active this frame...
      if (instr_key_resp_5.status === PsychoJS.Status.STARTED) {
        let theseKeys = instr_key_resp_5.getKeys({
          keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
          waitRelease: false
        });
      ...
      if (instr_sound_5.status === STARTED) {
          instr_sound_5.isPlaying = true;
          if (t >= (instr_sound_5.getDuration() + instr_sound_5.tStart)) {
              instr_sound_5.isFinished = true;
          }
      }
      ...
      if (instr_sound_5.status === PsychoJS.Status.STARTED && Boolean(false) || instr_sound_5.isFinished) {
        // keep track of stop time/frame for later
...
function expRoutineEachFrame() {
    return async function () {
      ...
      if (stimu.status === PsychoJS.Status.STARTED) {
      }
      ...
      if (stimu.status === PsychoJS.Status.STARTED && t >= frameRemains) {
        ...
        // update status
        stimu.status = PsychoJS.Status.FINISHED;
...
var block_fbMaxDurationReached;
var _block_fb_key_resp_allKeys;
var block_fbMaxDuration;
...
function block_fbRoutineBegin(snapshot) {
      return async function () {
        ...
        block_fbClock.reset();
        routineTimer.reset();
        block_fbMaxDurationReached = false;
        // update component parameters for each repeat
...
function block_fbRoutineEachFrame() {
      return async function () {
        ...
        if (block_feedb_text.status === PsychoJS.Status.STARTED) {
        }
        ...
        // if block_fb_key_resp is active this frame...
        if (block_fb_key_resp.status === PsychoJS.Status.STARTED) {
          let theseKeys = block_fb_key_resp.getKeys({
            keyList: typeof 'space' === 'string' ? ['space'] : 'space', 
            waitRelease: false
          });
...
function thanksRoutineEachFrame() {
      return async function () {
        ...
        if (endpage.status === PsychoJS.Status.STARTED) {
        }
        ...
        if (endpage.status === PsychoJS.Status.STARTED && t >= frameRemains) {
          ...
          // update status
          endpage.status = PsychoJS.Status.FINISHED;
