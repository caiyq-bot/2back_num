...
let expName = '2Back_nblocks';  // from the Builder filename that created this script
let expInfo = {
    'participant': '',
    'session': '001',
    'nBlocks': '1',
...
async function updateInfo() {
  ...
  psychoJS.experiment.dataFileName = (("." + "/") + `data/${expInfo["participant"]}_1_5_1_${expName}_${expInfo["session"]}_${expInfo["date"]}`);
...
function block_fbRoutineBegin(snapshot) {
      return async function () {
        ...
        blockn = (n_blocks-1 - block_loop.thisN);
        if ((exp_rt.length === 0)) {
            block_feedb = "\u60a8\u7684\u6b63\u786e\u7387\u4e3a0\u3002\n\u8bf7\u786e\u4fdd\u660e\u767d\u5b9e\u9a8c\u89c4\u5219\u518d\u7ee7\u7eed\u5b9e\u9a8c\u3002\n\n\n\u8bf7\u6309\u7a7a\u683c\u952e\u7ee7\u7eed\u3002";
        } else {
